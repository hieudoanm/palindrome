...
Palindrome is a focused project in this monorepo that delivers a practical tool with a clean user experience across platforms.

## ✨ 2. Features

1. [x] Core functionality tailored to Palindrome
...
- 🌐 [Live Demo](https://hieudoanm.github.io/palindrome/)

## 🚀 4. Usage

- 🌐 [Web](https://hieudoanm.github.io/palindrome/)
- 💻 [CLI](https://github.com/hieudoanm/palindrome/releases)
- 📱 [Mobile](https://github.com/hieudoanm/palindrome/releases)
- 🖥️ [Desktop](https://github.com/hieudoanm/palindrome/releases)
  - 🍎 [MacOS](https://github.com/hieudoanm/palindrome/releases/tag/macos-latest)
  - 🐧 [Ubuntu](https://github.com/hieudoanm/palindrome/releases/tag/ubuntu-latest)
  - 🪟 [Windows](https://github.com/hieudoanm/palindrome/releases/tag/windows-latest)
